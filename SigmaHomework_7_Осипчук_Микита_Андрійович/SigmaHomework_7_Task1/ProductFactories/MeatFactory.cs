...
namespace SigmaHomework_7_Task1.ProductFactories
{
    public class MeatFactory : ProductFactory
    {
        public override ProductModel Create()
        {
            ...
            return new MeatModel(product.Name, product.Price, product.Weight, meatTypeAnswer, meatCategoryAnswer, product.Courency);
        }
    }
}
